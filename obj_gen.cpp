...
void object_generator::alloc_value_buffer(void)
{
    ...
    if (size > 0) {
        ...
        if (!m_random_data) {
            ...
            if (m_compression_ratio > 0) {
                char *comp_part_start;
                unsigned int comp_part_size = (unsigned int)(size * m_compression_ratio / 100.0);
...
void object_generator::set_compression_ratio(unsigned short compression_ratio)
{
...
data_object* object_generator::get_object(int iter)
{
    ...
    if (m_random_data) {
        if (m_compression_ratio > 0) {
            unsigned int comp_part_new_size = (unsigned int)(new_size * m_compression_ratio / 100.0);
